...
local quality_pollution_scaling = settings.startup["omega-module-quality-pollution-scaling"].value
  ...
  data:extend({
    {
      ...
      pollution_quality_multiplier = quality_pollution_scaling and 1.0 or nil,
